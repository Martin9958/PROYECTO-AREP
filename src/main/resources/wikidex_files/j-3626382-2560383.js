...
(function(){
    ...
    (function() {
    var p = "3626382", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3626382||'',
    guid:window.ftGUID_3626382||'',
    confID:window.ftConfID_3626382||'0',
    ftReturn: window.ftReturn_3626382||'',
    keyword:window.ftKeyword_3626382||'',
    ftId:window.ftId_3626382||'',
    ftImpId:window.ftImp3626382 && window.ftImp3626382.impID || '',
    campaignID: '104200',
    cID:'100965',
    pID:'3626382',
    creativeID:'2560383',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=104200&sid=653&plc=3626382&num=&adid=&advid=&adsrv=29&btreg=3626382&btadsrv=flashtalking&crt=2560383&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/104200;3626382;2560383;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/mx/creativecloud/plans.html?sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?133885452-3626382;2560383;',
    centreAd: true,
    width:300,
    height:600,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/362/3626382/2560383/image/2560383.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/104200;3626382;202;pixel;DBM;DBMFY19CCPSPAudExCOLPPWB300x600/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/104200;3626382;2560383;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/mx/creativecloud/plans.html?sdid=GZKZY1B7&mv=display',
    divID:'ftdiv3626382',
    altimgID:'ftalt3626382',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3626382 && parseInt(window.ftImp3626382.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3626382') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3626382'),
    pageVisible: 'maybe',
...
//TA_1 min
//ftMinified
(function(b){var c=window["ftImp"+b.pID]&&window["ftImp"+b.pID].privacy;c&&"x"!==c||((new Image).src=b.replaceMacros("ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2035&ta_partner_did=[GUID]&ta_format=png",!0),"undefined"==typeof window.ftD9ResponseRegister&&(window.ftD9ResponseRegister=[]),window.ftD9ResponseRegister.push({getD9Id:function(){return window.ft_d9ID||""},d9Response:function(b){var a="";try{a=b.DeviceID[0]}catch(d){}"timeout"!=a&&a?this.getD9Id()||(window.ft_d9ID=a||"",this.getD9Id()&&(this.d9Response=function(){})):a="";a&&((new Image).src="ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2176&ta_partner_did="+a+"&ta_format=png")}}))}(ft3626382));
